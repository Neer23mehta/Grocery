...
const commonGetApis = async (params: string,) => {
  ...
  try {
    const res = await axios.get(`${process.env.NEXT_PUBLIC_GET_API}/${params}`, {
      headers: {
...
export const deleteApi = async (params: string) => {
  ...
  try {
    const res = await axios.delete(`${process.env.NEXT_PUBLIC_GET_API}/${params}`, {
      headers: {
        Authorizations: token,
        language: "en",
        refresh_token: refreshtoken
...
export const commonPostApis = async (params: string, formdata: URLSearchParams|FormData) => {
  ...
  try {
    const res = await axios.post(`${process.env.NEXT_PUBLIC_GET_API}/${params}`,formdata,{
      headers: {
        Authorizations: token,
        language: "en",
        refresh_token: refreshtoken
